...
import org.example.mira.controllers.MainController;
...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//*[@id='navbarNav']/div/i/text()").string(" admin"));
    }
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='11']/div").exists())
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='11']/div/div[2]/div[1]/span").string("fifth"))
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='11']/div/div[2]/div[2]/i/span").string("#new one"));
    }
}
